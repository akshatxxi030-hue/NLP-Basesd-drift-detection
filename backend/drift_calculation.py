...
df = pd.read_csv("data/current_news.csv")

with open("binary files/baseline_mean.pkl", "rb") as f:
    mean_baseline = pickle.load(f)

with open("binary files/vectorizer.pkl", "rb") as f:
    vectorizer = pickle.load(f)

with open("binary files/X_baseline.pkl", "rb") as f:
